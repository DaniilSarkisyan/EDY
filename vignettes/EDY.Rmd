...
As we can see, the results are the same as when using gene symbols from the original data set. The only observe change is with regard to the magnitude of the continuous value of EDY. It is due to the loss of some gene IDs during the translation, since not all the IDs find their equivalence in the consulted databases.
