...
gse73578 <- get_hgnc(x = gse73578, key.type = "entrezgene", key.col = "ENTREZ_GENE_ID")
...
tmp <- strsplit(fData(gse73578)[, "GB_ACC"], " /// ")
fData(gse73578)$GB_ACC <- unlist(lapply(tmp, function(x) x[1]))
