...
Let us illustrate how to compute EDY for a real `ExpressionSet` from a microarray experiment available at GEO. It contains information about gene expression in children with acute lymphoblastic leukemia that has been treated or not with glucocorticoids (GEO accesion number GSE73578). Data can be downloaded into R by:
